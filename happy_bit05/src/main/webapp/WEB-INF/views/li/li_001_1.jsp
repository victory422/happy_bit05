	...
	<form method="get" action="/li/li_005_1">
		...
		<div class="container">
			...
			<div class="input-group mb-12" style="margin-top: 30px;">
				...
				</select> <select id="category" name="type"
			...
			<div class="table-responsive">
				...
				<td style="text-align: right;"><input type="checkbox"></td>
					...
					<tbody id="table_list">
						<c:forEach var="board" items="${list }">
							...
							<tr class="success"
								onclick="location.href='/li/li_006_1?index=${board.li_index }'">
				...
				<div id="row">
					<div class="col-md-6">
						<a href="/li/li_005_1?li_b_type=후기게시판"><button type="button"
								class="btn btn-success">글작성</button></a>
					</div>
					<!-- 페이징  -->
					<div class="col-md-6">
						<ul class="pagination justify-content-end">
							<c:if test="${pageUtil.prev }">
								<li class="page-item"><a class="page-link"
									href="/li/li_001_1?page=${pageUtil.start-1}">Previous</a></li>
							</c:if>
							<c:forEach begin="${pageUtil.start }" end="${pageUtil.end }"
								var="pNum">
								<li class="page-item ${pNum==pageUtil.dto.page?'active':"" }"><a
									class="page-link" href="/li/li_001_1?page=${pNum }">${pNum }</a></li>
							</c:forEach>
							<c:if test="${pageUtil.next }">
								<li class="page-item"><a class="page-link"
									href="/li/li_001_1?page=${pageUtil.end+1 }">Next</a></li>
							</c:if>
						</ul>
					</div>
				</div>
