...
<div class="container text-center">
	<div class="row justify-content-center ">
		...
		<div class="col-4">
			<div id="muteCourse" class="overflow-auto" style="height:600px;"></div>
		</div>
	</div>
</div>
	            ...
	            $.ajax({
	          		...
	          		success : function(data){
	          			...
	          			for(var i = 0; i < data.length; i++){
		    				...
		    				//리스트에 나올 내용.
		    				course += '<form id="mainGet" action="../../lc/003/lc_get" method="post">';
		    				course += '<table id = "mainList'+ i +'" class="table table-bordered table-hover" onClick = "lcGet(' + data[i].lc_index + ')">';														
							course += '<tr>';
...
function lcGet(lc_index){
	window.location.href = "../lc/003/lc_get?pageNum=1&amount=12&type=&keyword=&lc_index=" + lc_index;
}
</script>
