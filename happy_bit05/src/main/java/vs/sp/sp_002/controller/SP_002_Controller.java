 ...
 */
@Controller
public class SP_002_Controller {
	
	private static final Logger logger = LoggerFactory.getLogger(SP_002_Controller.class);
	
	/**
	 * Simply selects the shop view to render by returning its name.
	 */
	@RequestMapping(value = "/sp_002_1", method = RequestMethod.GET)
